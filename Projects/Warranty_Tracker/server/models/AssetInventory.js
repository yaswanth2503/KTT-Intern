...
const Employee = require('./EmployeeCredentials');  // Keep this as is, import the function

module.exports = (sequelize) => {
  const EmployeeModel = Employee(sequelize);  // initialize Employee model
